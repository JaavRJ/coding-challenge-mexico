...
public class HistoryController {
    ...
    private Map<String, Object> toMap(TradeEntity t) {
        ...
        map.put("buyExchange", t.getBuyExchange() != null ? t.getBuyExchange() : "BINANCE");
        map.put("sellExchange", t.getSellExchange() != null ? t.getSellExchange() : "COINBASE");
        map.put("exchange", t.getExchange() != null ? t.getExchange() : (t.getBuyExchange() != null ? t.getBuyExchange() : "BINANCE"));
